export const clinic = {
  ...
  phone: "071 994 0215",
  emergency: "071 994 0215",
  whatsapp: "073 079 8884",
  email: "rikhotsontiyiso15@gmail.com",
  hours: [
    { day: "Monday – Friday", time: "08:00 – 17:00" },
    { day: "Saturday", time: "08:00 – 13:00" },
    { day: "Sunday", time: "Closed" },
    { day: "Emergency Line", time: "Available 24/7" },
  ],
  bank: {
    name: "Capitec Bank",
    accountNumber: "1623735678",
    accountHolder: "Ubuntu Family Healthcare Clinic",
    reference: "Use your booking reference as the payment reference",
  },
  medicalAids: [
    "Discovery Health",
    "Bonitas",
